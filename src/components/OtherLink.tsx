...
const OtherLink: FC<Props> = ({ title, href, image, description }) => (
  <a
    ...
    className="flex items-center gap-4 sm:gap-6 outline-none hover:scale-[1.02] px-4 sm:px-6 py-3 sm:py-4
                transition-all rounded-lg bg-gray-800 hover:bg-gray-700 focus:bg-gray-700
                active:ring-3 focus:ring-3 ring-sky-500/50 ease-in-out"
  >
    ...
    <div className="flex-1">
      ...
      <p className="text-sm sm:text-base opacity-60 font-light">{description}</p>
    </div>
